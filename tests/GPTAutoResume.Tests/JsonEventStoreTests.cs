...
public sealed class JsonEventStoreTests
{
    ...
    public void ExistingStoreSeesAttemptsWrittenByAnotherStoreInstance()
    {
        ...
        first.MarkResumeAttempted("event-a", new DateTimeOffset(2026, 9, 7, 8, 0, 0, TimeSpan.FromHours(8)), sent: false);
    ...
    public void SecondPreInputClaimForSameEventIsBlocked()
    {
        ...
        Assert.Throws<InvalidOperationException>(() =>
            second.MarkResumeAttempted("event-a", new DateTimeOffset(2026, 9, 7, 8, 0, 1, TimeSpan.FromHours(8)), sent: false));
    }
}
